...
-- Check for existence of opt.data_root_train
if not paths.dirp(opt.data_root_train) then
    error('Did not find directory: ', opt.data_root_train)
end

-- a cache file of the training metadata (if doesnt exist, will be created)
local cache = "cache"
local cache_prefix = opt.data_root_train:gsub('/', '_')
